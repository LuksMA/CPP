...
int main(){
    ...
    vector<Person> singleAndMale = iSingleAndMale -> meetCriteria(persons);

    ICriteria *iSingleOrFemale;
    OrCriteria ciSingleOrMale(cSingle,cFemale);
    iSingleOrFemale = &ciSingleOrMale;
    ...
    cout<<"Female: \n";printPersons(female);
    cout<<"Single: \n";printPersons(single);
    cout<<"Single And Male: \n";printPersons(singleAndMale);
